...
METRICS=(
 ...
 m('payout','Shareholder Distributions','Dividend Payout Ratio','payoutRatio','percent','payout','Guide: 0–60% retained cushion; 60–100% watch; >100% above earnings','ปันผล ÷ กำไร ใช้เป็นตัวชี้วัดความครอบคลุมเท่านั้น ไม่รับประกันปันผลในอนาคต; REIT ต้องดู FFO/AFFO แทนกำไร GAAP'),
