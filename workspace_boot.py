...
_MODULES = ('dashboard_ui', 'dashboard_views', 'dashboard_runtime',
            ...
            'dashboard_help', 'chart_ranges', 'dashboard_selection', 'chart_performance', 'ranking_board', 'ranking_engine', 'ranking_policy', 'data_quality', 'metadata_repair', 'quality_views', 'chart_inspector', 'return_periods')
